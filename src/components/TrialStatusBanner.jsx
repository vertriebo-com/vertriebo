...
export default function TrialStatusBanner({ 
  ...
  const getFreePreviewContent = () => ({
    ...
    description: 'Sie testen Vertriebo mit einer begrenzten Vorschau. Sie können bis zu 3 Firmenkontakte prüfen.',
    stats: `Vorschau-Kontakte: ${trial_leads_granted} / 3 genutzt`,
  ...
  const getVerifiedTrialContent = () => ({
    ...
    stats: 'Verfügbare Firmenkontakte im Testzugang: bis zu 25',
